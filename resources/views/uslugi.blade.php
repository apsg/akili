        ...
        <div class="row py-3">
            <div class="col-md-12 col-sm-12">
                ...
                <ul>
                    ...
                    <li>dodatkowe spotkania diagnostyczne – 150 - 200zł</li>
                    <li>obserwacja dziecka na terenie placówki edukacyjnej – wg indywidualnych ustaleń</li>
                </ul>
            </div>
        </div>
    </div>
